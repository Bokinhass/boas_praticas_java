...
public class PetService {
  ...
  private final HttpCfgClient client;

  public PetService(HttpCfgClient client) {
    this.client = client;
  }

  public void importartPetsAbrigo() throws IOException, InterruptedException {
    ...
    while ((line = reader.readLine()) != null) {
      ...
      HttpResponse<String> response = client.dispararPost(uri, json);
